...
>[!NOTE]
>In NET MAUI the Blazor Views are equivalent to Activities in Kotlin, in the case of MAUI is not required a Second or more activities, the Main Activity serve as an App Container where is executed all the logic, and the "Activities" are handled by a Router.

### IDE and Emulator
![IDE Working](<Screenshot From 2025-09-21 17-16-26.png>)

### Sample app in emulator
![Sample emulator](<Screenshot From 2025-09-21 17-38-57.png>)

### First Activity/View oriented to Buttons
![alt text](ButtonsView.jpeg)

### Second Activity/View oriented to Lists
![alt text](ListView.jpeg)
![alt text](ListView2.jpeg)

### Third Activity/View oriented to Selects
![alt text](ToggleView2.jpeg)
![alt text](ToggleView.jpeg)

### Fourth Activity/View oriented to Texts
![alt text](TextView.jpeg)
![alt text](TextView2.jpeg) 
### Fifth Activity/View oriented to Progress bars
![alt text](ProgressBar.jpeg)

### Other Fragments as ThemeSwitcher and NavMenu
![alt text](ThemeSwitcher.jpeg) 
![alt text](NavMenu.jpeg)   